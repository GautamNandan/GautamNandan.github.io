...
//Splash screen
  ...
  splash_close: "Close",
  splash_message: "<p><b>This application is a fork from BIPES: Block based Integrated Platform for Embedded Systems</B> which allows text and block based programming for several types of embedded systems and Internet of Things <p>Special thanks to BIPES Team!</p>"
...
Blockly.Msg['CAT_PROJECTS'] = "Projects";
...
Blockly.Msg['BIPES_HUE'] = 290;          // Purple - for BIPES-specific blocks
Blockly.Msg['PYTHON_HUE'] = 230;         // Blue - Python's traditional color
Blockly.Msg['TIMING_HUE'] = 120;         // Green - for time/delays
Blockly.Msg['CONNECTIVITY_HUE'] = 260;   // Blue-Purple - for connection blocks
Blockly.Msg['MACHINE_HUE'] = 0;          // Red - for machine/hardware control
Blockly.Msg['DISPLAYS_HUE'] = 160;       // Cyan - for display outputs
Blockly.Msg['INPUT_HUE'] = 180;          // Light Blue - for input operations
Blockly.Msg['SENSORS_HUE'] = 200;        // Blue - for sensor readings
Blockly.Msg['OUTPUTS_HUE'] = 30;         // Orange - for output actions
Blockly.Msg['COMM_HUE'] = 190;           // Sky Blue - for communication
Blockly.Msg['FILES_HUE'] = 45;           // Orange-Yellow - for file operations
Blockly.Msg['NET_HUE'] = 210;            // Deep Blue - for network operations
Blockly.Msg['CONTROL_HUE'] = 330;        // Pink - for control flow
Blockly.Msg['MICROPYTHON_HUE'] = 250;    // Indigo - for MicroPython specifics
Blockly.Msg['CUSTOMLIB_HUE'] = 65;       // Yellow-Green - for custom libraries