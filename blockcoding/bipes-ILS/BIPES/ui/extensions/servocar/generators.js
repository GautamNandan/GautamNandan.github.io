...
Blockly.Python['ils_car_move'] = function(block) {
  ...
  switch(direction) {
    case 'FORWARD':
      code = 'ils_car.move_forward(' + speed + ')\n';
      break;
    case 'BACKWARD':
      code = 'ils_car.move_backward(' + speed + ')\n';
      break;
    case 'LEFT':
      code = 'ils_car.turn_left(' + speed + ')\n';
      break;
    case 'RIGHT':
      code = 'ils_car.turn_right(' + speed + ')\n';
      break;
    case 'STOP':
      code = 'ils_car.stop()\n';
      break;
