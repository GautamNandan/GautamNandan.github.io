...
function FreeboardModel(a, b, c) {
    ...
    this.version = 0, this.isEditing = ko.observable(!1), this.allow_edit = ko.observable(!1), this.allow_edit.subscribe(function(a) {
        ...
        if (c) var g = new Blob([JSON.stringify(d.serialize(), null, "\t")], {
            type: e
        });
        else var g = new Blob([JSON.stringify(d.serialize())], {
            type: e
        });
        document.body.appendChild(f), f.href = window.URL.createObjectURL(g), f.download = "dashboard.json", f.target = "_self", f.click()
...
function FreeboardUI() {
    ...
    function b(a) {
        f(r.cols + 1) && g(function() {
            var b, c = this,
                d = ko.dataFor(c),
                e = r.cols > 1 ? r.cols - 1 : 1,
                f = d.col[e],
                g = d.row[e];
            a ? (leftPreviewCol = !0, b = {
                row: g,
                col: f < r.cols ? f + 1 : r.cols
            }) : (rightPreviewCol = !0, b = {
                row: g,
                col: f
    ...
    function f(a) {
        ...
        a > b && (a = b);
        var c = v * a + a;
        return $(".responsive-column-width").css("max-width", c), a !== r.cols
    }
...
function PaneModel(a, b) {
    ...
    this.title = ko.observable(), this.width = ko.observable(1), this.row = {}, this.col = {}, this.col_width = ko.observable(1), this.col_width.subscribe(function(a) {
        ...
        return c.widgets.indexOf(a) < c.widgets().length - 1
    ...
    this.datasourceRefreshNotifications = {}, this.calculatedSettingScripts = {}, this.title = ko.observable(), this.fillSize = ko.observable(!1), this.type = ko.observable(), this.type.subscribe(function(a) {
        function e() {
            f.newInstance(d.settings(), function(a) {
                d.fillSize(!0 === f.fill_size), d.widgetInstance = a, d.shouldRender(!0), d._heightUpdate.valueHasMutated()
            })
        }
        ...
        if (_.isFunction(d.calculatedSettingScripts[a])) {
            ...
            try {
                ...
                var c = d.settings()[a];
                e instanceof ReferenceError && /^\w+$/.test(c) && (b = c)
            }
                ...
                if ("calculated" == a.type) {
                    ...
                    if (!_.isUndefined(b)) {
                        ...
                        try {
                            ...
                            var g = e[a.name].replace(/"/g, '\\"').replace(/[\r\n]/g, " \\\n");
                            f = new Function("datasources", 'return "' + g + '";')
                        }
                        d.calculatedSettingScripts[a.name] = f, d.processCalculatedSetting(a.name);
                        for (var h; h = c.exec(b);) {
                            var i = h[1] || h[2],
                                j = d.datasourceRefreshNotifications[i];
                            _.isUndefined(j) && (j = [], d.datasourceRefreshNotifications[i] = j), -1 == _.indexOf(j, a.name) && j.push(a.name)
                        }
                    }
                }
            })
...
DatasourceModel = function(a, b) {
        ...
        this.name = ko.observable(), this.latestData = ko.observable(), this.settings = ko.observable({}), this.settings.subscribe(function(a) {
            ...
            return new Function("data", "return " + a + ";").call(void 0, d.latestData())
        ...
        function g(a, b, g, h, i) {
            ...
            n.append(o), new DialogBox(n, a, "Save", "Cancel", function() {
                ...
                for (var a = 0; a < l.settings.length; a++) {
                    ...
                    if ("integer" == b.type && m.settings[b.name] % 1 != 0) return c(b.name, "Must be a whole number."), !0;
        ...
        function b(a, b) {
            return !(!_.isArray(a) && !_.isObject(a)) || c(a, b)
        }
        ...
        function h(a, b, c, d) {
            var e = c.value;
            return c.preview && (e = e + "<span class='preview'>" + c.preview + "</span>"), $("<li>" + e + "</li>").appendTo(k).mouseenter(function() {
        ...
        function i(a, b) {
            $(a).addClass("calculated-value-input").bind("keyup mouseup freeboard-eval", function(c) {
                if (k && "keyup" == c.type && (38 == c.keyCode || 40 == c.keyCode || 13 == c.keyCode)) return void c.preventDefault();
                g(a, b)
            }).focus(function() {
                $(a).css({
                    "z-index": 3001
                ...
                if (k)
                    if (38 == a.keyCode || 40 == a.keyCode) {
                        a.preventDefault();
                        var b = $(k).find("li");
                        38 == a.keyCode ? l-- : 40 == a.keyCode && l++, l < 0 ? l = b.size() - 1 : l >= b.size() && (l = 0);
                        var c = $(b).eq(l);
    ...
    function(a) {
        ...
        a.fn.attrchange = function(e) {
            ...
            if ("function" == typeof e ? f.callback = e : a.extend(f, e), f.trackValues && a(this).each(function(b, c) {
                    for (var d, e = {}, b = 0, f = c.attributes, g = f.length; b < g; b++) d = f.item(b), e[d.nodeName] = d.value;
        ...
        init: function(a, f, g, i, j) {
            ...
            "datasource" == k.type ? (l = b, n = "Datasource") : "widget" == k.type ? (l = c, n = "Widget") : "pane" == k.type && (n = "Pane"), $(a).click(function(f) {
                if ("delete" == k.operation) {
                    new DialogBox($("<p>Are you sure you want to delete this " + n + "?</p>"), "Confirm Delete", "Yes", "No", function() {
                        "datasource" == k.type ? e.deleteDatasource(i) : "widget" == k.type ? e.deleteWidget(i) : "pane" == k.type && e.deletePane(i)
                    })
                } else {
                    var g = void 0;
                    "datasource" == k.type ? "add" == k.operation ? m = {} : (g = i.type(), m = i.settings(), m.name = i.name()) : "widget" == k.type ? "add" == k.operation ? m = {} : (g = i.type(), m = i.settings()) : "pane" == k.type && (m = {}, "edit" == k.operation && (m.title = i.title(), m.col_width = i.col_width()), l = {
                        settings: {
                            settings: [{
                                name: "title",
                                display_name: "Title",
                    ...
                    }), h.createPluginEditor(n, l, g, m, function(f) {
                        if ("add" == k.operation) {
...
$.extend(freeboard, jQuery.eventEmitter),
    function() {
        ...
        var c = function(a, b) {
            ...
            this.updateNow = function() {
                ...
                dweetio.stop_listening_for(e.thing_id), e = a, dweetio.listen_for(e.thing_id, function(a) {
                    c(a.content)
                })
    ...
    function() {
        ...
        function c(a, b, c) {
            ...
            var i = function(a, b) {
                f[b] || (f[b] = []), f[b].length >= d && f[b].shift(), f[b].push(Number(a)), (void 0 === g || a < g) && (g = a), (void 0 === h || a > h) && (h = a)
            };
