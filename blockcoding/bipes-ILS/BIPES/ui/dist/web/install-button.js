class n extends HTMLElement {
  static preload() {
    import("./connect-8a9a703c.js?module").then((function(n) {
      return n.c;
    }));
  }
  ...
  connectedCallback() {
    ...
    e.addEventListener("click", async (n) => {
      n.preventDefault();
      (await import("./connect-8a9a703c.js?module").then((function(n) {
        return n.c;
      }))).connect(this);
    });
    e.name = "activate";
